...
def example_aae(path, adversarial_optimizer):
    ...
    model.fit(x=xtrain, y=y, validation_data=(xtest, ytest), callbacks=[TensorBoard(log_dir=path)],
                        nb_epoch=200, batch_size=46)
...
def main():
    example_aae("keras_aae", AdversarialOptimizerSimultaneous())
